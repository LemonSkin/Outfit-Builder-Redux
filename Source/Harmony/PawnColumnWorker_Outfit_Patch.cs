        ...
        )
        {
            if (pawn.outfits.forcedHandler.SomethingIsForced)
            {
                ...
                if (pawn.IsQuestLodger())
                {
                    ...
                    Widgets.Label(
                        outfit_rect,
                        "Unchangeable".Translate().Truncate(outfit_rect.width, null)
                    );
                ...
                {
                    Widgets.Dropdown<Pawn, ApparelPolicy>(
                        outfit_rect,
                        pawn,
                ...
                Rect clear_forced_rect = new Rect(
                    rect_x,
                    rect_y,
                    rect_width_short + 3f,
                    rect_height
                ...
                if (
                    Widgets.ButtonText(
                        clear_forced_rect,
                        "OBR.ClearForcedApparel".Translate().Truncate(clear_forced_rect.width),
                        true,
                        true,
                        true
                    )
                    ...
                    TooltipHandler.TipRegion(
                        ...
                        new TipSignal(
                            delegate()
                            {
                                ...
                                foreach (
                                    Apparel apparel in pawn.outfits.forcedHandler.ForcedApparel
                                )
                                {
                                    text = text + "\n   " + apparel.LabelCap;
                                }
                ...
                Rect save_overwrite_rect = new Rect(
                    rect_x,
                    rect_y,
                    rect_width_short + 2f,
                    rect_height
                ...
                if (
                    Widgets.ButtonText(
                        save_overwrite_rect,
                        "OBR.Save".Translate().Truncate(save_overwrite_rect.width).Resolve(),
                        true,
                        true,
                        true
                    )
                ...
                if (Mouse.IsOver(save_overwrite_rect))
                {
                    TooltipHandler.TipRegion(
                        ...
                        new TipSignal(
                            ...
                            {
                                string text =
                                    "Left click: Save outfit (overwrites)\nRight click: Update outfit";
                                return text;
                            },
                            pawn.GetHashCode() * 612
                        )
